...
const RC_API_KEY = Platform.select({
  ios: process.env.EXPO_PUBLIC_RC_IOS_KEY || 'appl_ReTKwQALEVJxGdPURfKpyZNAqGl',
  android: process.env.EXPO_PUBLIC_RC_ANDROID_KEY || 'goog_nDUGrrRzQRLJnFwZDsAeSiawdxd',
});
